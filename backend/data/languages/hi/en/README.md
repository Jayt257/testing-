# LearnWise — Hindi → English Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Hindi→English roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **English language learning course** where the **teaching language is Hindi**.

- **All explanations and instructions must be in Hindi**
- **All target language text must be in English** (Latin script) with romanization + Hindi translation
...
2. **Target text**: Always include English script + romanization + Hindi meaning
...
```
You are generating LearnWise content for Hindi→English.

File: data/languages/hi/en/month-1/week-1-lesson.json
...
All explanations in Hindi. All English text with romanization + Hindi translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "hi-en", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Hindi→English Content Guide | See data/README.md for complete block type schemas*
