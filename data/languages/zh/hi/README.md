# LearnWise — Mandarin Chinese → Hindi Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Mandarin Chinese→Hindi roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Hindi language learning course** where the **teaching language is Mandarin Chinese**.

- **All explanations and instructions must be in Mandarin Chinese**
- **All target language text must be in Hindi** (Devanagari script) with romanization + Mandarin Chinese translation
...
2. **Target text**: Always include Hindi script + romanization + Mandarin Chinese meaning
...
```
You are generating LearnWise content for Mandarin Chinese→Hindi.

File: data/languages/zh/hi/month-1/week-1-lesson.json
...
All explanations in Mandarin Chinese. All Hindi text with romanization + Mandarin Chinese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "zh-hi", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Mandarin Chinese→Hindi Content Guide | See data/README.md for complete block type schemas*
