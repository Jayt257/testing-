# LearnWise — Mandarin Chinese → Spanish Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Mandarin Chinese→Spanish roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Spanish language learning course** where the **teaching language is Mandarin Chinese**.

- **All explanations and instructions must be in Mandarin Chinese**
- **All target language text must be in Spanish** (Latin script) with romanization + Mandarin Chinese translation
...
2. **Target text**: Always include Spanish script + romanization + Mandarin Chinese meaning
...
```
You are generating LearnWise content for Mandarin Chinese→Spanish.

File: data/languages/zh/es/month-1/week-1-lesson.json
...
All explanations in Mandarin Chinese. All Spanish text with romanization + Mandarin Chinese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "zh-es", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Mandarin Chinese→Spanish Content Guide | See data/README.md for complete block type schemas*
