# LearnWise — French → Hindi Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete French→Hindi roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Hindi language learning course** where the **teaching language is French**.

- **All explanations and instructions must be in French**
- **All target language text must be in Hindi** (Devanagari script) with romanization + French translation
...
2. **Target text**: Always include Hindi script + romanization + French meaning
...
```
You are generating LearnWise content for French→Hindi.

File: data/languages/fr/hi/month-1/week-1-lesson.json
...
All explanations in French. All Hindi text with romanization + French translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "fr-hi", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*French→Hindi Content Guide | See data/README.md for complete block type schemas*
