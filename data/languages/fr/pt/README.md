# LearnWise — French → Portuguese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete French→Portuguese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Portuguese language learning course** where the **teaching language is French**.

- **All explanations and instructions must be in French**
- **All target language text must be in Portuguese** (Latin script) with romanization + French translation
...
2. **Target text**: Always include Portuguese script + romanization + French meaning
...
```
You are generating LearnWise content for French→Portuguese.

File: data/languages/fr/pt/month-1/week-1-lesson.json
...
All explanations in French. All Portuguese text with romanization + French translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "fr-pt", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*French→Portuguese Content Guide | See data/README.md for complete block type schemas*
