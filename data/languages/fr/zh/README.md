# LearnWise — French → Mandarin Chinese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete French→Mandarin Chinese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Mandarin Chinese language learning course** where the **teaching language is French**.

- **All explanations and instructions must be in French**
- **All target language text must be in Mandarin Chinese** (Hanzi (Characters) script) with romanization + French translation
...
1. **Explanations**: Always write in French
2. **Target text**: Always include Mandarin Chinese script + romanization + French meaning
...
```
You are generating LearnWise content for French→Mandarin Chinese.

File: data/languages/fr/zh/month-1/week-1-lesson.json
...
All explanations in French. All Mandarin Chinese text with romanization + French translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "fr-zh", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*French→Mandarin Chinese Content Guide | See data/README.md for complete block type schemas*
