# LearnWise — French → English Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete French→English roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **English language learning course** where the **teaching language is French**.

- **All explanations and instructions must be in French**
- **All target language text must be in English** (Latin script) with romanization + French translation
...
2. **Target text**: Always include English script + romanization + French meaning
...
```
You are generating LearnWise content for French→English.

File: data/languages/fr/en/month-1/week-1-lesson.json
...
All explanations in French. All English text with romanization + French translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "fr-en", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*French→English Content Guide | See data/README.md for complete block type schemas*
