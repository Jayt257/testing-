# LearnWise — English → Arabic Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete English→Arabic roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Arabic language learning course** where the **teaching language is English**.

- **All explanations and instructions must be in English**
- **All target language text must be in Arabic** (Arabic (RTL) script) with romanization + English translation
...
2. **Target text**: Always include Arabic script + romanization + English meaning
...
```
You are generating LearnWise content for English→Arabic.

File: data/languages/en/ar/month-1/week-1-lesson.json
...
All explanations in English. All Arabic text with romanization + English translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "en-ar", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*English→Arabic Content Guide | See data/README.md for complete block type schemas*
