# LearnWise — English → Mandarin Chinese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete English→Mandarin Chinese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Mandarin Chinese language learning course** where the **teaching language is English**.

- **All explanations and instructions must be in English**
- **All target language text must be in Mandarin Chinese** (Hanzi (Characters) script) with romanization + English translation
...
1. **Explanations**: Always write in English
2. **Target text**: Always include Mandarin Chinese script + romanization + English meaning
...
```
You are generating LearnWise content for English→Mandarin Chinese.

File: data/languages/en/zh/month-1/week-1-lesson.json
...
All explanations in English. All Mandarin Chinese text with romanization + English translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "en-zh", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*English→Mandarin Chinese Content Guide | See data/README.md for complete block type schemas*
