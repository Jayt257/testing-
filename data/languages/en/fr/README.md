# LearnWise — English → French Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete English→French roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **French language learning course** where the **teaching language is English**.

- **All explanations and instructions must be in English**
- **All target language text must be in French** (Latin script) with romanization + English translation
...
2. **Target text**: Always include French script + romanization + English meaning
...
```
You are generating LearnWise content for English→French.

File: data/languages/en/fr/month-1/week-1-lesson.json
...
All explanations in English. All French text with romanization + English translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "en-fr", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*English→French Content Guide | See data/README.md for complete block type schemas*
