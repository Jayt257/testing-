# LearnWise — Arabic → Korean Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Arabic→Korean roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Korean language learning course** where the **teaching language is Arabic**.

- **All explanations and instructions must be in Arabic**
- **All target language text must be in Korean** (Hangul script) with romanization + Arabic translation
...
2. **Target text**: Always include Korean script + romanization + Arabic meaning
...
```
You are generating LearnWise content for Arabic→Korean.

File: data/languages/ar/ko/month-1/week-1-lesson.json
...
All explanations in Arabic. All Korean text with romanization + Arabic translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ar-ko", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Arabic→Korean Content Guide | See data/README.md for complete block type schemas*
