# LearnWise — Arabic → Spanish Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Arabic→Spanish roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Spanish language learning course** where the **teaching language is Arabic**.

- **All explanations and instructions must be in Arabic**
- **All target language text must be in Spanish** (Latin script) with romanization + Arabic translation
...
2. **Target text**: Always include Spanish script + romanization + Arabic meaning
...
```
You are generating LearnWise content for Arabic→Spanish.

File: data/languages/ar/es/month-1/week-1-lesson.json
...
All explanations in Arabic. All Spanish text with romanization + Arabic translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ar-es", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Arabic→Spanish Content Guide | See data/README.md for complete block type schemas*
