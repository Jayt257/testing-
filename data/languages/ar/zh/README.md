# LearnWise — Arabic → Mandarin Chinese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Arabic→Mandarin Chinese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Mandarin Chinese language learning course** where the **teaching language is Arabic**.

- **All explanations and instructions must be in Arabic**
- **All target language text must be in Mandarin Chinese** (Hanzi (Characters) script) with romanization + Arabic translation
...
1. **Explanations**: Always write in Arabic
2. **Target text**: Always include Mandarin Chinese script + romanization + Arabic meaning
...
```
You are generating LearnWise content for Arabic→Mandarin Chinese.

File: data/languages/ar/zh/month-1/week-1-lesson.json
...
All explanations in Arabic. All Mandarin Chinese text with romanization + Arabic translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ar-zh", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Arabic→Mandarin Chinese Content Guide | See data/README.md for complete block type schemas*
