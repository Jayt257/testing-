# LearnWise — German → Portuguese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete German→Portuguese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Portuguese language learning course** where the **teaching language is German**.

- **All explanations and instructions must be in German**
- **All target language text must be in Portuguese** (Latin script) with romanization + German translation
...
2. **Target text**: Always include Portuguese script + romanization + German meaning
...
```
You are generating LearnWise content for German→Portuguese.

File: data/languages/de/pt/month-1/week-1-lesson.json
...
All explanations in German. All Portuguese text with romanization + German translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "de-pt", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*German→Portuguese Content Guide | See data/README.md for complete block type schemas*
