# LearnWise — German → Japanese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete German→Japanese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Japanese language learning course** where the **teaching language is German**.

- **All explanations and instructions must be in German**
- **All target language text must be in Japanese** (Mixed (Hiragana/Katakana/Kanji) script) with romanization + German translation
...
2. **Target text**: Always include Japanese script + romanization + German meaning
...
```
You are generating LearnWise content for German→Japanese.

File: data/languages/de/ja/month-1/week-1-lesson.json
...
All explanations in German. All Japanese text with romanization + German translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "de-ja", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*German→Japanese Content Guide | See data/README.md for complete block type schemas*
