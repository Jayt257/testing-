# LearnWise — German → Mandarin Chinese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete German→Mandarin Chinese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Mandarin Chinese language learning course** where the **teaching language is German**.

- **All explanations and instructions must be in German**
- **All target language text must be in Mandarin Chinese** (Hanzi (Characters) script) with romanization + German translation
...
1. **Explanations**: Always write in German
2. **Target text**: Always include Mandarin Chinese script + romanization + German meaning
...
```
You are generating LearnWise content for German→Mandarin Chinese.

File: data/languages/de/zh/month-1/week-1-lesson.json
...
All explanations in German. All Mandarin Chinese text with romanization + German translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "de-zh", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*German→Mandarin Chinese Content Guide | See data/README.md for complete block type schemas*
