# LearnWise — German → Korean Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete German→Korean roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Korean language learning course** where the **teaching language is German**.

- **All explanations and instructions must be in German**
- **All target language text must be in Korean** (Hangul script) with romanization + German translation
...
2. **Target text**: Always include Korean script + romanization + German meaning
...
```
You are generating LearnWise content for German→Korean.

File: data/languages/de/ko/month-1/week-1-lesson.json
...
All explanations in German. All Korean text with romanization + German translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "de-ko", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*German→Korean Content Guide | See data/README.md for complete block type schemas*
