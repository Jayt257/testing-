# LearnWise — Spanish → Hindi Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Spanish→Hindi roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Hindi language learning course** where the **teaching language is Spanish**.

- **All explanations and instructions must be in Spanish**
- **All target language text must be in Hindi** (Devanagari script) with romanization + Spanish translation
...
2. **Target text**: Always include Hindi script + romanization + Spanish meaning
...
```
You are generating LearnWise content for Spanish→Hindi.

File: data/languages/es/hi/month-1/week-1-lesson.json
...
All explanations in Spanish. All Hindi text with romanization + Spanish translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "es-hi", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Spanish→Hindi Content Guide | See data/README.md for complete block type schemas*
