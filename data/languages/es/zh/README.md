# LearnWise — Spanish → Mandarin Chinese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Spanish→Mandarin Chinese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Mandarin Chinese language learning course** where the **teaching language is Spanish**.

- **All explanations and instructions must be in Spanish**
- **All target language text must be in Mandarin Chinese** (Hanzi (Characters) script) with romanization + Spanish translation
...
1. **Explanations**: Always write in Spanish
2. **Target text**: Always include Mandarin Chinese script + romanization + Spanish meaning
...
```
You are generating LearnWise content for Spanish→Mandarin Chinese.

File: data/languages/es/zh/month-1/week-1-lesson.json
...
All explanations in Spanish. All Mandarin Chinese text with romanization + Spanish translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "es-zh", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Spanish→Mandarin Chinese Content Guide | See data/README.md for complete block type schemas*
