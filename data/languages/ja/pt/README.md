# LearnWise — Japanese → Portuguese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Japanese→Portuguese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Portuguese language learning course** where the **teaching language is Japanese**.

- **All explanations and instructions must be in Japanese**
- **All target language text must be in Portuguese** (Latin script) with romanization + Japanese translation
- **Cultural notes should reflect Portuguese-speaking culture and customs**
...
| Script | Latin |
| CEFR Difficulty | **A** |
| Key Fact | 260M speakers, Brazil + Portugal + Africa, nasal vowels |
...
- **Easy difficulty**: Similar script and grammar to many European languages
- Learners can read the script immediately
- Focus on vocabulary differences and pronunciation
...
2. **Target text**: Always include Portuguese script + romanization + Japanese meaning
...
7. **Cultural notes**: Include at least 1 per week about Portuguese culture
...
```
You are generating LearnWise content for Japanese→Portuguese.

File: data/languages/ja/pt/month-1/week-1-lesson.json
...
All explanations in Japanese. All Portuguese text with romanization + Japanese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ja-pt", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Japanese→Portuguese Content Guide | See data/README.md for complete block type schemas*
