# LearnWise — Japanese → Arabic Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Japanese→Arabic roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Arabic language learning course** where the **teaching language is Japanese**.

- **All explanations and instructions must be in Japanese**
- **All target language text must be in Arabic** (Arabic (RTL) script) with romanization + Japanese translation
...
2. **Target text**: Always include Arabic script + romanization + Japanese meaning
...
```
You are generating LearnWise content for Japanese→Arabic.

File: data/languages/ja/ar/month-1/week-1-lesson.json
...
All explanations in Japanese. All Arabic text with romanization + Japanese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ja-ar", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Japanese→Arabic Content Guide | See data/README.md for complete block type schemas*
