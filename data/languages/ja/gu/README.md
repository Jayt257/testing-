# LearnWise — Japanese → Gujarati Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Japanese→Gujarati roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Gujarati language learning course** where the **teaching language is Japanese**.

- **All explanations and instructions must be in Japanese**
- **All target language text must be in Gujarati** (Gujarati script) with romanization + Japanese translation
...
2. **Target text**: Always include Gujarati script + romanization + Japanese meaning
...
```
You are generating LearnWise content for Japanese→Gujarati.

File: data/languages/ja/gu/month-1/week-1-lesson.json
...
All explanations in Japanese. All Gujarati text with romanization + Japanese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ja-gu", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Japanese→Gujarati Content Guide | See data/README.md for complete block type schemas*
