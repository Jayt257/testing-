# LearnWise — Japanese → French Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Japanese→French roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **French language learning course** where the **teaching language is Japanese**.

- **All explanations and instructions must be in Japanese**
- **All target language text must be in French** (Latin script) with romanization + Japanese translation
...
2. **Target text**: Always include French script + romanization + Japanese meaning
...
```
You are generating LearnWise content for Japanese→French.

File: data/languages/ja/fr/month-1/week-1-lesson.json
...
All explanations in Japanese. All French text with romanization + Japanese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ja-fr", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Japanese→French Content Guide | See data/README.md for complete block type schemas*
