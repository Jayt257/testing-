# LearnWise — Japanese → Mandarin Chinese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Japanese→Mandarin Chinese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Mandarin Chinese language learning course** where the **teaching language is Japanese**.

- **All explanations and instructions must be in Japanese**
- **All target language text must be in Mandarin Chinese** (Hanzi (Characters) script) with romanization + Japanese translation
...
1. **Explanations**: Always write in Japanese
2. **Target text**: Always include Mandarin Chinese script + romanization + Japanese meaning
...
```
You are generating LearnWise content for Japanese→Mandarin Chinese.

File: data/languages/ja/zh/month-1/week-1-lesson.json
...
All explanations in Japanese. All Mandarin Chinese text with romanization + Japanese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ja-zh", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Japanese→Mandarin Chinese Content Guide | See data/README.md for complete block type schemas*
