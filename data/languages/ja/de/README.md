# LearnWise — Japanese → German Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Japanese→German roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **German language learning course** where the **teaching language is Japanese**.

- **All explanations and instructions must be in Japanese**
- **All target language text must be in German** (Latin script) with romanization + Japanese translation
...
2. **Target text**: Always include German script + romanization + Japanese meaning
...
```
You are generating LearnWise content for Japanese→German.

File: data/languages/ja/de/month-1/week-1-lesson.json
...
All explanations in Japanese. All German text with romanization + Japanese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ja-de", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Japanese→German Content Guide | See data/README.md for complete block type schemas*
