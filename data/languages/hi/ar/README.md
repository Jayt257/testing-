# LearnWise — Hindi → Arabic Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Hindi→Arabic roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Arabic language learning course** where the **teaching language is Hindi**.

- **All explanations and instructions must be in Hindi**
- **All target language text must be in Arabic** (Arabic (RTL) script) with romanization + Hindi translation
...
2. **Target text**: Always include Arabic script + romanization + Hindi meaning
...
```
You are generating LearnWise content for Hindi→Arabic.

File: data/languages/hi/ar/month-1/week-1-lesson.json
...
All explanations in Hindi. All Arabic text with romanization + Hindi translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "hi-ar", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Hindi→Arabic Content Guide | See data/README.md for complete block type schemas*
