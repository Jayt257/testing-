# LearnWise — Hindi → Korean Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Hindi→Korean roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Korean language learning course** where the **teaching language is Hindi**.

- **All explanations and instructions must be in Hindi**
- **All target language text must be in Korean** (Hangul script) with romanization + Hindi translation
...
2. **Target text**: Always include Korean script + romanization + Hindi meaning
...
```
You are generating LearnWise content for Hindi→Korean.

File: data/languages/hi/ko/month-1/week-1-lesson.json
...
All explanations in Hindi. All Korean text with romanization + Hindi translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "hi-ko", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Hindi→Korean Content Guide | See data/README.md for complete block type schemas*
