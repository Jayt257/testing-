# LearnWise — Hindi → French Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Hindi→French roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **French language learning course** where the **teaching language is Hindi**.

- **All explanations and instructions must be in Hindi**
- **All target language text must be in French** (Latin script) with romanization + Hindi translation
...
2. **Target text**: Always include French script + romanization + Hindi meaning
...
```
You are generating LearnWise content for Hindi→French.

File: data/languages/hi/fr/month-1/week-1-lesson.json
...
All explanations in Hindi. All French text with romanization + Hindi translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "hi-fr", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Hindi→French Content Guide | See data/README.md for complete block type schemas*
