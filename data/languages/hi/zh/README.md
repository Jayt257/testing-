# LearnWise — Hindi → Mandarin Chinese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Hindi→Mandarin Chinese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Mandarin Chinese language learning course** where the **teaching language is Hindi**.

- **All explanations and instructions must be in Hindi**
- **All target language text must be in Mandarin Chinese** (Hanzi (Characters) script) with romanization + Hindi translation
...
2. **Target text**: Always include Mandarin Chinese script + romanization + Hindi meaning
...
```
You are generating LearnWise content for Hindi→Mandarin Chinese.

File: data/languages/hi/zh/month-1/week-1-lesson.json
...
All explanations in Hindi. All Mandarin Chinese text with romanization + Hindi translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "hi-zh", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Hindi→Mandarin Chinese Content Guide | See data/README.md for complete block type schemas*
