# LearnWise — Korean → French Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Korean→French roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **French language learning course** where the **teaching language is Korean**.

- **All explanations and instructions must be in Korean**
- **All target language text must be in French** (Latin script) with romanization + Korean translation
...
2. **Target text**: Always include French script + romanization + Korean meaning
...
```
You are generating LearnWise content for Korean→French.

File: data/languages/ko/fr/month-1/week-1-lesson.json
...
All explanations in Korean. All French text with romanization + Korean translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ko-fr", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Korean→French Content Guide | See data/README.md for complete block type schemas*
