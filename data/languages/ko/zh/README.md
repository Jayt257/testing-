# LearnWise — Korean → Mandarin Chinese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Korean→Mandarin Chinese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Mandarin Chinese language learning course** where the **teaching language is Korean**.

- **All explanations and instructions must be in Korean**
- **All target language text must be in Mandarin Chinese** (Hanzi (Characters) script) with romanization + Korean translation
...
1. **Explanations**: Always write in Korean
2. **Target text**: Always include Mandarin Chinese script + romanization + Korean meaning
...
```
You are generating LearnWise content for Korean→Mandarin Chinese.

File: data/languages/ko/zh/month-1/week-1-lesson.json
...
All explanations in Korean. All Mandarin Chinese text with romanization + Korean translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "ko-zh", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Korean→Mandarin Chinese Content Guide | See data/README.md for complete block type schemas*
