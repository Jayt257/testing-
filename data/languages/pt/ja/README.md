# LearnWise — Portuguese → Japanese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Portuguese→Japanese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Japanese language learning course** where the **teaching language is Portuguese**.

- **All explanations and instructions must be in Portuguese**
- **All target language text must be in Japanese** (Mixed (Hiragana/Katakana/Kanji) script) with romanization + Portuguese translation
...
2. **Target text**: Always include Japanese script + romanization + Portuguese meaning
...
```
You are generating LearnWise content for Portuguese→Japanese.

File: data/languages/pt/ja/month-1/week-1-lesson.json
...
All explanations in Portuguese. All Japanese text with romanization + Portuguese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "pt-ja", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Portuguese→Japanese Content Guide | See data/README.md for complete block type schemas*
