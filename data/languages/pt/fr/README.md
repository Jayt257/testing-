# LearnWise — Portuguese → French Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Portuguese→French roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **French language learning course** where the **teaching language is Portuguese**.

- **All explanations and instructions must be in Portuguese**
- **All target language text must be in French** (Latin script) with romanization + Portuguese translation
- **Cultural notes should reflect French-speaking culture and customs**
...
| Script | Latin |
| CEFR Difficulty | **A** |
| Key Fact | Official language of 29 countries, language of diplomacy |
...
2. **Target text**: Always include French script + romanization + Portuguese meaning
...
7. **Cultural notes**: Include at least 1 per week about French culture
...
```
You are generating LearnWise content for Portuguese→French.

File: data/languages/pt/fr/month-1/week-1-lesson.json
...
All explanations in Portuguese. All French text with romanization + Portuguese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "pt-fr", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Portuguese→French Content Guide | See data/README.md for complete block type schemas*
