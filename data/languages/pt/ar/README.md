# LearnWise — Portuguese → Arabic Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Portuguese→Arabic roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Arabic language learning course** where the **teaching language is Portuguese**.

- **All explanations and instructions must be in Portuguese**
- **All target language text must be in Arabic** (Arabic (RTL) script) with romanization + Portuguese translation
- **Cultural notes should reflect Arabic-speaking culture and customs**
...
| Script | Arabic (RTL) |
| CEFR Difficulty | **C** |
| Key Fact | Right-to-left, 420M speakers, 22+ countries, Quran language |
...
- Script note: Arabic (RTL)
- **RTL (right-to-left)**: Mention text direction in script introduction blocks
...
2. **Target text**: Always include Arabic script + romanization + Portuguese meaning
...
7. **Cultural notes**: Include at least 1 per week about Arabic culture
...
```
You are generating LearnWise content for Portuguese→Arabic.

File: data/languages/pt/ar/month-1/week-1-lesson.json
...
All explanations in Portuguese. All Arabic text with romanization + Portuguese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "pt-ar", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Portuguese→Arabic Content Guide | See data/README.md for complete block type schemas*
