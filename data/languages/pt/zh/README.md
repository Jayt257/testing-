# LearnWise — Portuguese → Mandarin Chinese Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Portuguese→Mandarin Chinese roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Mandarin Chinese language learning course** where the **teaching language is Portuguese**.

- **All explanations and instructions must be in Portuguese**
- **All target language text must be in Mandarin Chinese** (Hanzi (Characters) script) with romanization + Portuguese translation
- **Cultural notes should reflect Mandarin Chinese-speaking culture and customs**
...
| Script | Hanzi (Characters) |
| CEFR Difficulty | **C** |
| Key Fact | 1.1B speakers, 4 tones, no alphabet — characters represent meaning |
...
- Script note: Hanzi (Characters)
- **Tonal language**: Must include tone markers in all word entries
- Use pinyin romanization system
...
1. **Explanations**: Always write in Portuguese
2. **Target text**: Always include Mandarin Chinese script + romanization + Portuguese meaning
...
7. **Cultural notes**: Include at least 1 per week about Mandarin Chinese culture
...
```
You are generating LearnWise content for Portuguese→Mandarin Chinese.

File: data/languages/pt/zh/month-1/week-1-lesson.json
...
All explanations in Portuguese. All Mandarin Chinese text with romanization + Portuguese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "pt-zh", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Portuguese→Mandarin Chinese Content Guide | See data/README.md for complete block type schemas*
