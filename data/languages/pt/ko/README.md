# LearnWise — Portuguese → Korean Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Portuguese→Korean roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Korean language learning course** where the **teaching language is Portuguese**.

- **All explanations and instructions must be in Portuguese**
- **All target language text must be in Korean** (Hangul script) with romanization + Portuguese translation
- **Cultural notes should reflect Korean-speaking culture and customs**
...
| Script | Hangul |
| CEFR Difficulty | **C** |
| Key Fact | 77M speakers, Hangul alphabet (1443 AD), honorific system |
...
- Script note: Hangul
- **Hangul script**: Regular alphabet, learnable in ~2 hours
- Honorific speech levels: Start with formal polite (습니다/합니다) form
...
2. **Target text**: Always include Korean script + romanization + Portuguese meaning
...
7. **Cultural notes**: Include at least 1 per week about Korean culture
...
```
You are generating LearnWise content for Portuguese→Korean.

File: data/languages/pt/ko/month-1/week-1-lesson.json
...
All explanations in Portuguese. All Korean text with romanization + Portuguese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "pt-ko", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Portuguese→Korean Content Guide | See data/README.md for complete block type schemas*
