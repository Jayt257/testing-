# LearnWise — Portuguese → Hindi Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Portuguese→Hindi roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Hindi language learning course** where the **teaching language is Portuguese**.

- **All explanations and instructions must be in Portuguese**
- **All target language text must be in Hindi** (Devanagari script) with romanization + Portuguese translation
- **Cultural notes should reflect Hindi-speaking culture and customs**
...
| Script | Devanagari |
| CEFR Difficulty | **B** |
| Key Fact | Official language of India, 600M speakers |
...
2. **Target text**: Always include Hindi script + romanization + Portuguese meaning
...
7. **Cultural notes**: Include at least 1 per week about Hindi culture
...
```
You are generating LearnWise content for Portuguese→Hindi.

File: data/languages/pt/hi/month-1/week-1-lesson.json
...
All explanations in Portuguese. All Hindi text with romanization + Portuguese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "pt-hi", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Portuguese→Hindi Content Guide | See data/README.md for complete block type schemas*
