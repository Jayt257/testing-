# LearnWise — Portuguese → English Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Portuguese→English roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **English language learning course** where the **teaching language is Portuguese**.

- **All explanations and instructions must be in Portuguese**
- **All target language text must be in English** (Latin script) with romanization + Portuguese translation
- **Cultural notes should reflect English-speaking culture and customs**
...
| Script | Latin |
| CEFR Difficulty | **A** |
| Key Fact | World's most spoken language, native to UK/USA |
...
2. **Target text**: Always include English script + romanization + Portuguese meaning
...
7. **Cultural notes**: Include at least 1 per week about English culture
...
```
You are generating LearnWise content for Portuguese→English.

File: data/languages/pt/en/month-1/week-1-lesson.json
...
All explanations in Portuguese. All English text with romanization + Portuguese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "pt-en", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Portuguese→English Content Guide | See data/README.md for complete block type schemas*
