# LearnWise — Portuguese → Spanish Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Portuguese→Spanish roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **Spanish language learning course** where the **teaching language is Portuguese**.

- **All explanations and instructions must be in Portuguese**
- **All target language text must be in Spanish** (Latin script) with romanization + Portuguese translation
- **Cultural notes should reflect Spanish-speaking culture and customs**
...
| Script | Latin |
| CEFR Difficulty | **A** |
| Key Fact | 500M speakers, 20+ countries, second most spoken language |
...
2. **Target text**: Always include Spanish script + romanization + Portuguese meaning
...
7. **Cultural notes**: Include at least 1 per week about Spanish culture
...
```
You are generating LearnWise content for Portuguese→Spanish.

File: data/languages/pt/es/month-1/week-1-lesson.json
...
All explanations in Portuguese. All Spanish text with romanization + Portuguese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "pt-es", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Portuguese→Spanish Content Guide | See data/README.md for complete block type schemas*
