# LearnWise — Portuguese → German Content Generation Guide

> **For AI Agents & Human Admins**  
> This file + `data/README.md` is everything needed to generate the complete Portuguese→German roadmap.

---

## AI AGENT INSTRUCTIONS

You are generating a **German language learning course** where the **teaching language is Portuguese**.

- **All explanations and instructions must be in Portuguese**
- **All target language text must be in German** (Latin script) with romanization + Portuguese translation
- **Cultural notes should reflect German-speaking culture and customs**
...
| Script | Latin |
| CEFR Difficulty | **B** |
| Key Fact | 100M speakers, compound words, economic powerhouse |
...
2. **Target text**: Always include German script + romanization + Portuguese meaning
...
7. **Cultural notes**: Include at least 1 per week about German culture
...
```
You are generating LearnWise content for Portuguese→German.

File: data/languages/pt/de/month-1/week-1-lesson.json
...
All explanations in Portuguese. All German text with romanization + Portuguese translation.
Week 1 theme: Script/sounds, vowels, basic greetings, numbers 1-100, family

Follow JSON schema from data/README.md Section 5.
Set: "langPair": "pt-de", "id": 1, "xp": 30, "week": 1, "month": 1
```

---

*Portuguese→German Content Guide | See data/README.md for complete block type schemas*
